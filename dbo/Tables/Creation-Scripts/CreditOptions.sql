...
GO
CREATE TABLE [dbo].[CreditOptions](
...
GO
ALTER TABLE [dbo].[CreditOptions]  WITH CHECK ADD  CONSTRAINT [ECreditApprovedStructure_CreditOptions] FOREIGN KEY([CreditApprovedStructureId])
REFERENCES [dbo].[CreditApprovedStructures] ([Id])
ON DELETE CASCADE
GO
ALTER TABLE [dbo].[CreditOptions] CHECK CONSTRAINT [ECreditApprovedStructure_CreditOptions]
GO
