...
GO
CREATE TABLE [dbo].[CreditApplicationReceivableVATInfoes](
...
GO
ALTER TABLE [dbo].[CreditApplicationReceivableVATInfoes]  WITH CHECK ADD  CONSTRAINT [ECreditApplication_CreditApplicationReceivableVATInfoes] FOREIGN KEY([CreditApplicationId])
REFERENCES [dbo].[CreditApplications] ([Id])
ON DELETE CASCADE
GO
ALTER TABLE [dbo].[CreditApplicationReceivableVATInfoes] CHECK CONSTRAINT [ECreditApplication_CreditApplicationReceivableVATInfoes]
GO
