...
GO
CREATE TABLE [dbo].[LeaseCashFlows](
...
GO
ALTER TABLE [dbo].[LeaseCashFlows]  WITH CHECK ADD  CONSTRAINT [ELeaseFinance_LeaseCashFlows] FOREIGN KEY([LeaseFinanceId])
REFERENCES [dbo].[LeaseFinances] ([Id])
ON DELETE CASCADE
GO
ALTER TABLE [dbo].[LeaseCashFlows] CHECK CONSTRAINT [ELeaseFinance_LeaseCashFlows]
GO
