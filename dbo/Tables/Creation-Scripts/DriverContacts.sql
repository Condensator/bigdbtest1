...
GO
ALTER TABLE [dbo].[DriverContacts]  WITH CHECK ADD  CONSTRAINT [EDriver_DriverContacts] FOREIGN KEY([DriverId])
REFERENCES [dbo].[Drivers] ([Id])
ON DELETE CASCADE
GO
ALTER TABLE [dbo].[DriverContacts] CHECK CONSTRAINT [EDriver_DriverContacts]
GO
ALTER TABLE [dbo].[DriverContacts]  WITH CHECK ADD  CONSTRAINT [EDriverContact_CIPDocumentSourceName] FOREIGN KEY([CIPDocumentSourceNameId])
REFERENCES [dbo].[CIPDocumentSourceConfigs] ([Id])
GO
ALTER TABLE [dbo].[DriverContacts] CHECK CONSTRAINT [EDriverContact_CIPDocumentSourceName]
GO
ALTER TABLE [dbo].[DriverContacts]  WITH CHECK ADD  CONSTRAINT [EDriverContact_MailingAddress] FOREIGN KEY([MailingAddressId])
REFERENCES [dbo].[DriverAddresses] ([Id])
GO
ALTER TABLE [dbo].[DriverContacts] CHECK CONSTRAINT [EDriverContact_MailingAddress]
GO
ALTER TABLE [dbo].[DriverContacts]  WITH CHECK ADD  CONSTRAINT [EDriverContact_PartyContact] FOREIGN KEY([PartyContactId])
REFERENCES [dbo].[PartyContacts] ([Id])
GO
ALTER TABLE [dbo].[DriverContacts] CHECK CONSTRAINT [EDriverContact_PartyContact]
GO
