...
GO
CREATE TABLE [dbo].[CreditApplicationPaymentSchedules](
...
GO
ALTER TABLE [dbo].[CreditApplicationPaymentSchedules]  WITH CHECK ADD  CONSTRAINT [ECreditApplication_CreditApplicationPaymentSchedules] FOREIGN KEY([CreditApplicationId])
REFERENCES [dbo].[CreditApplications] ([Id])
ON DELETE CASCADE
GO
ALTER TABLE [dbo].[CreditApplicationPaymentSchedules] CHECK CONSTRAINT [ECreditApplication_CreditApplicationPaymentSchedules]
GO
