...
GO
CREATE TABLE [dbo].[ProposalExhibitYields](
...
GO
ALTER TABLE [dbo].[ProposalExhibitYields]  WITH CHECK ADD  CONSTRAINT [EProposalExhibit_ProposalExhibitYields] FOREIGN KEY([ProposalExhibitId])
REFERENCES [dbo].[ProposalExhibits] ([Id])
ON DELETE CASCADE
GO
ALTER TABLE [dbo].[ProposalExhibitYields] CHECK CONSTRAINT [EProposalExhibit_ProposalExhibitYields]
GO
