...
GO
CREATE TABLE [dbo].[LoanAmendmentPaymentSchedules](
...
GO
ALTER TABLE [dbo].[LoanAmendmentPaymentSchedules]  WITH CHECK ADD  CONSTRAINT [ELoanAmendment_LoanAmendmentPaymentSchedules] FOREIGN KEY([LoanAmendmentId])
REFERENCES [dbo].[LoanAmendments] ([Id])
ON DELETE CASCADE
GO
ALTER TABLE [dbo].[LoanAmendmentPaymentSchedules] CHECK CONSTRAINT [ELoanAmendment_LoanAmendmentPaymentSchedules]
GO
