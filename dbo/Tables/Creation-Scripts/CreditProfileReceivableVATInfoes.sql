...
GO
CREATE TABLE [dbo].[CreditProfileReceivableVATInfoes](
...
GO
ALTER TABLE [dbo].[CreditProfileReceivableVATInfoes]  WITH CHECK ADD  CONSTRAINT [ECreditApprovedStructure_CreditProfileReceivableVATInfoes] FOREIGN KEY([CreditApprovedStructureId])
REFERENCES [dbo].[CreditApprovedStructures] ([Id])
ON DELETE CASCADE
GO
ALTER TABLE [dbo].[CreditProfileReceivableVATInfoes] CHECK CONSTRAINT [ECreditApprovedStructure_CreditProfileReceivableVATInfoes]
GO
