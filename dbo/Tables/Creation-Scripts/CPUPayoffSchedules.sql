...
GO
CREATE TABLE [dbo].[CPUPayoffSchedules](
...
GO
ALTER TABLE [dbo].[CPUPayoffSchedules]  WITH CHECK ADD  CONSTRAINT [ECPUPayoff_CPUPayoffSchedules] FOREIGN KEY([CPUPayoffId])
REFERENCES [dbo].[CPUPayoffs] ([Id])
ON DELETE CASCADE
GO
ALTER TABLE [dbo].[CPUPayoffSchedules] CHECK CONSTRAINT [ECPUPayoff_CPUPayoffSchedules]
GO
