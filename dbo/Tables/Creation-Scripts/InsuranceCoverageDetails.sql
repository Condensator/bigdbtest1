...
GO
CREATE TABLE [dbo].[InsuranceCoverageDetails](
...
GO
ALTER TABLE [dbo].[InsuranceCoverageDetails]  WITH CHECK ADD  CONSTRAINT [EInsuranceCoverageDetail_CoverageTypeConfig] FOREIGN KEY([CoverageTypeConfigId])
REFERENCES [dbo].[CoverageTypeConfigs] ([Id])
GO
ALTER TABLE [dbo].[InsuranceCoverageDetails] CHECK CONSTRAINT [EInsuranceCoverageDetail_CoverageTypeConfig]
GO
ALTER TABLE [dbo].[InsuranceCoverageDetails]  WITH CHECK ADD  CONSTRAINT [EInsuranceTemplate_InsuranceCoverageDetails] FOREIGN KEY([InsuranceTemplateId])
REFERENCES [dbo].[InsuranceTemplates] ([Id])
ON DELETE CASCADE
GO
ALTER TABLE [dbo].[InsuranceCoverageDetails] CHECK CONSTRAINT [EInsuranceTemplate_InsuranceCoverageDetails]
GO
