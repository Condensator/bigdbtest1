...
GO
CREATE TABLE [dbo].[ReceiptApplicationInvoices](
...
GO
ALTER TABLE [dbo].[ReceiptApplicationInvoices]  WITH CHECK ADD  CONSTRAINT [EReceiptApplication_ReceiptApplicationInvoices] FOREIGN KEY([ReceiptApplicationId])
REFERENCES [dbo].[ReceiptApplications] ([Id])
ON DELETE CASCADE
GO
ALTER TABLE [dbo].[ReceiptApplicationInvoices] CHECK CONSTRAINT [EReceiptApplication_ReceiptApplicationInvoices]
GO
ALTER TABLE [dbo].[ReceiptApplicationInvoices]  WITH CHECK ADD  CONSTRAINT [EReceiptApplicationInvoice_ReceivableInvoice] FOREIGN KEY([ReceivableInvoiceId])
REFERENCES [dbo].[ReceivableInvoices] ([Id])
GO
ALTER TABLE [dbo].[ReceiptApplicationInvoices] CHECK CONSTRAINT [EReceiptApplicationInvoice_ReceivableInvoice]
GO
