...
GO
ALTER TABLE [dbo].[Portfolios]  WITH CHECK ADD  CONSTRAINT [EPortfolio_MasterPortfolio] FOREIGN KEY([MasterPortfolioId])
REFERENCES [dbo].[Portfolios] ([Id])
GO
ALTER TABLE [dbo].[Portfolios] CHECK CONSTRAINT [EPortfolio_MasterPortfolio]
GO
