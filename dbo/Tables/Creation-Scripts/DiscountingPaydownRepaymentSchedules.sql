...
GO
CREATE TABLE [dbo].[DiscountingPaydownRepaymentSchedules](
...
GO
ALTER TABLE [dbo].[DiscountingPaydownRepaymentSchedules]  WITH CHECK ADD  CONSTRAINT [EDiscountingPaydown_DiscountingPaydownRepaymentSchedules] FOREIGN KEY([DiscountingPaydownId])
REFERENCES [dbo].[DiscountingPaydowns] ([Id])
ON DELETE CASCADE
GO
ALTER TABLE [dbo].[DiscountingPaydownRepaymentSchedules] CHECK CONSTRAINT [EDiscountingPaydown_DiscountingPaydownRepaymentSchedules]
GO
