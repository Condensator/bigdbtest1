...
GO
CREATE TABLE [dbo].[CCRReportDelinquencies](
...
GO
ALTER TABLE [dbo].[CCRReportDelinquencies]  WITH CHECK ADD  CONSTRAINT [EDNAParametersForCreditDecision_CCRReportDelinquencies] FOREIGN KEY([DNAParametersForCreditDecisionId])
REFERENCES [dbo].[DNAParametersForCreditDecisions] ([Id])
ON DELETE CASCADE
GO
ALTER TABLE [dbo].[CCRReportDelinquencies] CHECK CONSTRAINT [EDNAParametersForCreditDecision_CCRReportDelinquencies]
GO
