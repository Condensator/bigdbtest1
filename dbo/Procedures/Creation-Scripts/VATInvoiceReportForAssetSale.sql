...
CREATE PROCEDURE [dbo].[VATInvoiceReportForAssetSale]
(
@InvoiceId BIGINT,
...
BlendTaxAmount,
BlendNumber ,
DetailId  from GetAssetSaleBlendDetailsForVATInvoiceFormat(@InvoiceID,@BillToId) AS blenddetails
)
SELECT
RID.Id,
...
FROM ReceivableInvoices RI
	...
	LEFT JOIN RemitToWireDetails RTWD ON RT.Id = RTWD.RemitToId
