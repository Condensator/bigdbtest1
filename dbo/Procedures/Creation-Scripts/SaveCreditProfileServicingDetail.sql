...
CREATE PROC [dbo].[SaveCreditProfileServicingDetail]
(
 @val [dbo].[CreditProfileServicingDetail] READONLY
)
AS
SET NOCOUNT ON;
...
MERGE [dbo].[CreditProfileServicingDetails] With (ForceSeek) AS T
