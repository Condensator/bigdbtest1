...
CREATE PROC [dbo].[SaveDirectCreditBureauReasonCodeFieldConfig]
(
 @val [dbo].[DirectCreditBureauReasonCodeFieldConfig] READONLY
)
AS
SET NOCOUNT ON;
...
MERGE [dbo].[DirectCreditBureauReasonCodeFieldConfigs] With (ForceSeek) AS T
