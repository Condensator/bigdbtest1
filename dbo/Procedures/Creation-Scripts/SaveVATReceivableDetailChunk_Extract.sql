...
CREATE PROC [dbo].[SaveVATReceivableDetailChunk_Extract]
(
 @val [dbo].[VATReceivableDetailChunk_Extract] READONLY
)
AS
SET NOCOUNT ON;
...
MERGE [dbo].[VATReceivableDetailChunk_Extract] With (ForceSeek) AS T
