...
GO
CREATE PROCEDURE [dbo].[UpdateLeaseIncomeSchedulesFromSyndication]
(
...
and LeaseIncomeSchedules.IncomeDate >= @EffectiveDate
GROUP BY LeaseIncomeSchedules.Id,LeaseIncomeSchedules.BeginNetBookValue_Currency
...
FROM
#LeaseIncomeSummary
JOIN LeaseIncomeSchedules ON #LeaseIncomeSummary.LeaseIncomeScheduleId = LeaseIncomeSchedules.Id
END
