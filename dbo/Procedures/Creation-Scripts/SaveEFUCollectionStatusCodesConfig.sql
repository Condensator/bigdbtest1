...
CREATE PROC [dbo].[SaveEFUCollectionStatusCodesConfig]
(
 @val [dbo].[EFUCollectionStatusCodesConfig] READONLY
)
AS
SET NOCOUNT ON;
...
MERGE [dbo].[EFUCollectionStatusCodesConfigs] With (ForceSeek) AS T
