...
CREATE PROC [dbo].[SaveCPUBaseChargeReversalJobExtract]
(
 @val [dbo].[CPUBaseChargeReversalJobExtract] READONLY
)
AS
SET NOCOUNT ON;
...
MERGE [dbo].[CPUBaseChargeReversalJobExtracts] With (ForceSeek) AS T
