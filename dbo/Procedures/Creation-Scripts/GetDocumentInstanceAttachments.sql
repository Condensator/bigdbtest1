...
CREATE PROCEDURE [dbo].[GetDocumentInstanceAttachments]
(
@DocumentInstanceId						BIGINT,
...
' FROM 
DocumentAttachments 
INNER JOIN AttachmentForDocs ON DocumentAttachments.AttachmentId=AttachmentForDocs.Id
...
where DocumentAttachments.DocumentInstanceId = @DocumentInstanceId AND
DocumentAttachments.IsActive = 1 AND
'
