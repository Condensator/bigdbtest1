...
CREATE PROC [dbo].[SaveEFUAccountDesignatorCodesConfig]
(
 @val [dbo].[EFUAccountDesignatorCodesConfig] READONLY
)
AS
SET NOCOUNT ON;
...
MERGE [dbo].[EFUAccountDesignatorCodesConfigs] With (ForceSeek) AS T
