...
CREATE PROC [dbo].[SaveEFUScoringIndicatorCodesConfig]
(
 @val [dbo].[EFUScoringIndicatorCodesConfig] READONLY
)
AS
SET NOCOUNT ON;
...
MERGE [dbo].[EFUScoringIndicatorCodesConfigs] With (ForceSeek) AS T
