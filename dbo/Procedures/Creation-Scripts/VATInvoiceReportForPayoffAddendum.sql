...
CREATE PROCEDURE [dbo].[VATInvoiceReportForPayoffAddendum]
(
@InvoiceId BIGINT
) WITH RECOMPILE
AS
...
CustomerNumber,
rd.AssetId,
assets.Id [AssetSerialNumber], /* Need to implement proper logic to retrieve serial number. As a temporary fix, Id is replaced in place of Serial Number to avoid crash in the report.*/
